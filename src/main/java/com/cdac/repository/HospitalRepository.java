...
public interface HospitalRepository extends JpaRepository<Hospital, Integer> {
	...
	//@Query("select h from Hospital h where h.email=:email and h.password=:password")
		...
		@Query("select ventilator, oxygen, normal from Hospital h where h.id=:id")
		List<Object[]> findBedByHospitalId(int id);
		...
		@Query("select hospitalname,ventilator, oxygen, normal from Hospital h")
		List<Object[]> getAllBedWithhospitalName();
